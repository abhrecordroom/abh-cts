...
import { unitFormSchema, unitFormSchemaType } from "@/lib/validations"

export default function Page() {
  const form = useForm<unitFormSchemaType>({
  ...
  async function onSubmit(data: unitFormSchemaType) {
    alert(`${data.unitName},"\n",${data.unitCode},"\n ",${data.activeState}`)
  }
                    ...
                    <div className="flex flex-col gap-5 p-3">
                      ...
                      <Controller
                        ...
                        render={({ field, fieldState }) => (
                          <Field>
                            <FieldLabel>Name of Unit</FieldLabel>
                            <Input
                              {...field}
                              id="unitName"
                        ...
                        render={({ field, fieldState }) => (
                          <Field>
                            ...
                            <Input
                              {...field}
                              id="unitCode"
                              placeholder="Enter short form of unit name"
                              value={field.value}
                            />
                            {fieldState.invalid && (
                              <FieldError
